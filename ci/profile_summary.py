...
profile is reported as its own row. Each CLAS12 detector's digitization plugin therefore appears as its
own row (ecal, ftof, dc, ltcc, ft_cal, ...) without editing this file.
