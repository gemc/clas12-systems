...
#
# The maps come from the magfield git-lfs subproject (subprojects/magfield), whose path is
# passed as argv[1] by the top-level meson.build. Every *.dat file in that directory is copied,
